...
import { PropertyTypeDefinition, WithProperty } from '..'
import { WithBrand, WithFlavor } from '../Brands'
...
describe('KeepProperties', () => {
  ...
  it('keeps only the listed properties', () => {
    ...
    type KeepP3P1 = KeepProperties<P1P2P3, 'P3' | 'P1'>
  ...
  it('is compatible with brand', () => {
    ...
    type KeepP3P1 = KeepProperties<BrandedP1P2P3, 'P3' | 'P1'>
  ...
  it('is compatible with flavor', () => {
    ...
    type KeepP3P1 = KeepProperties<FlavoredP1P2P3, 'P3' | 'P1'>
...
describe('KeepPropertyIfValueMatches', () => {
  ...
  it('keeps property if the set value matches (one property)', () => {
    type R = KeepPropertyIfValueMatches<Red, 'Color', 'Green' | 'Blue'>
    type G = KeepPropertyIfValueMatches<Green, 'Color', 'Green' | 'Blue'>
    type B = KeepPropertyIfValueMatches<Blue, 'Color', 'Green' | 'Blue'>
  ...
  it('keeps property if the set value matches (many properties)', () => {
    ...
    type R = KeepPropertyIfValueMatches<BigRed, 'Color', 'Green' | 'Blue'>
    type G = KeepPropertyIfValueMatches<BigGreen, 'Color', 'Green' | 'Blue'>
    type B = KeepPropertyIfValueMatches<BigBlue, 'Color', 'Green' | 'Blue'>
